    ...
    return(
        ...
        <>
            <div className="mt-6 lg:mx-80 lg:px-12 px-8 mx-10 py-10 border-2 rounded-4xl border-[#197686] bg-[#05252C]">
                    ...
                    <div className="lg:border-2 rounded-4xl border-[#0E464F] bg-[#08252B] my-5 lg:px-5">
                        <div className="text-center my-5 lg:px-6 py-3 border-2 rounded-4xl border-[#07373F] bg-[#05252C] text-white">
                            <h1 className="Tech lg:text-6xl text-5xl text-white">Techember Fest "25</h1>
                            <p className="join lg:text-sm text-sm my-2">Join us for an unforgettable <br className="lg:hidden block"/> experience at<br className="lg:block hidden" /> [Event Name]! Secure <br className="lg:hidden block"/> your spot now.</p>
                            <div className="text-center mt-6 lg:mt-0">
                                <p className="join lg:text-sm text-sm">📍 [Event Location]<br className="lg:hidden block"/> || March 15, 2025 | 7:00 PM</p>
                            </div>
                        </div>
                        ...
                        <div>
                            <h1 className="join text-white text-sm lg:text-sm pb-2">Select Ticket Type:</h1>
                            <div className="grid lg:grid-cols-3 gap-2 bg-[#052228] border-2 border-[#07373F] rounded-2xl px-2 py-2">
                                <div className={`text-white py-3 px-3 border-2 border-[#197686] rounded-lg join hover:cursor-pointer ${selectedTicket === "Regular Access" ? "bg-[#197686]" : "bg-[#052228]"} ${ errors.ticket ? "border-red-500" : "border-[#07373F]"}`} {...register("ticket")} onClick={() => handleSelect("Regular Access")}>
                                    <div className="join">
                                ...
                                <div className={`text-white py-3 px-3 border-2 border-[#197686] rounded-lg join hover:cursor-pointer ${selectedTicket === "VIP Access" ? "bg-[#197686]" : "bg-[#052228]"} ${ errors.ticket ? "border-red-500" : "border-[#07373F]"}`} {...register("ticket")} onClick={() => handleSelect("VIP Access")}>
                                    <div className="join">
                                ...
                                <div className={`text-white py-3 px-3 border-2 border-[#197686] rounded-lg join hover:cursor-pointer ${selectedTicket === "VVIP Access" ? "bg-[#197686]" : "bg-[#052228]"} ${ errors.ticket ? "border-red-500" : "border-[#07373F]"}`} {...register("ticket")} onClick={() => handleSelect("VVIP Access")}>
                                <div className="join">
                                        <p className="font-extrabold text-2xl">$150</p> 
            ...
            <p className="text-red-500 text-sm mt-1">{errors.ticket.message}</p>
                            ...
                            <h1 className="join text-white mt-10 text-sm lg:text-sm mb-2">Number of Tickets</h1>
                            <select name="" id="" className={`w-full border-2 border-[#07373F] bg-[#08252B] rounded-2xl py-3 px-4 text-white ${
